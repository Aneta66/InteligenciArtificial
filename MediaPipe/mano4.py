...
#-----------------------------------
    ...
    lado_cuadrado = int(distancia_indice_medio)
    centro_x = pulgar[0] + 20
    centro_y = pulgar[1] + 20

    pt1_x = centro_x - lado_cuadrado // 2
    pt1_y = centro_y - lado_cuadrado // 2
    pt2_x = centro_x + lado_cuadrado // 2
    pt2_y = centro_y + lado_cuadrado // 2

    cv2.rectangle(frame, (pt1_x, pt1_y), (pt2_x, pt2_y), (34, 234, 65), 2)
#---------------------


    #cv2.rectangle(frame, (pulgar[0]+20,pulgar[1]+20), (300,300), (255, 0, 0), 3)
    #cv2.rectangle(frame, pulgar, indice, (0, 255, 0), 3)
